...
function SchedulerV2(props) {
    const { L10n, loadCldr, getLocaleByLanguage, language = "En", height, dayView, weekView, workWeekView, monthView, agendaView, currentView: startingCurrentView, firstDayOfWeek = 1, closedDates = [], events, onChangeDate, onChangeView, onChangeAgendaRange } = props;
